...
bash "host-sync" do
	...
	if [ -d /var/chef/cache/cookbooks/hosts/files/default/etc ]; then
        	if [ -f /var/chef/cache/cookbooks/hosts/files/default/etc/dev_hosts ]; then
                cp /var/chef/cache/cookbooks/hosts/files/default/etc/dev_hosts /var/chef/cache/cookbooks/hosts/files/default/etc/tmphosts
                while read line; do
